...
namespace WHEELS
{
    ...
    constexpr double kEncoderTicksPerMotorRadian      = k_encoder_ticks_per_rotation / (2 * pi);  //Number of ticks per radian
    constexpr double kEncoderTicksPerWheelRadian      = gear_ratio * kEncoderTicksPerMotorRadian; //Total amount of ticks per wheel radian
